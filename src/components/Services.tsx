        ...
        {services.map((service, index) => {
          ...
          return <div key={index} className="service-card opacity-0 translate-y-8 group bg-gradient-to-b from-gray-900/50 to-black/50 p-8 rounded-2xl border border-white/10 hover:border-blue-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-2 shadow-lg hover:shadow-2xl hover:shadow-blue-500/10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              {/* <div className={`w-16 h-16  ${service.gradient} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-900 shadow-lg group-hover:${service.shadow} group-hover:shadow-2xl animate-pulse`}>
                <IconComponent strokeWidth={2.5} className="w-8 h-8 text-blue-400 group-hover:text-blue-300 transition-colors duration-300" />

              </div> */}
              <div className={`w-16 h-16 ${service.gradient} rounded-2xl flex items-center justify-center mb-6 transform transition-all duration-500 shadow-lg group-hover:${service.shadow} group-hover:shadow-2xl group-hover:scale-110 group-hover:rotate-3`}>
  <IconComponent strokeWidth={2.5} className="w-8 h-8 text-blue-400 group-hover:text-blue-300 transition-colors duration-300" />
</div>
